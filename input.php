...
<!-- Modal-->
        ...
        <div class="col-md-9">
        	<div class="thumbnail" style="height:340">
<div class="progress">
  <div class="progress-bar progress-bar-success progress-bar-striped active" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 25%;">
    Proses Input Data
  </div>
</div>
            ...
            <p><input type='text' name='ni' value='' size='50' placeholder='No. Induk Peserta Didik' class='form-control' required/></p>
            <p><input type='text' name='nama'  value='' size='50' placeholder='Nama Lengkap' class='form-control' required /></p>
            <p><select name='kelas' class='form-control' />
            ...
            <p><select name='semester' class='form-control' />
            <option value='1'>Semester 1</option>
            <option value='2'>Semester 2</option>
            </select>
            </p>
            <p><input type='submit' id='submit' name='lanjut1' value="Lanjut" class="btn btn-primary"></p>
            </form>
            </div>
            <div class="col-md-2"></div>
            </div>
